...
# NOTE: BEWARE of importing anything from the broader package into this module.
# It is likely to cause a circular import.
...
def get_logger(
    ...
    logging.setLoggerClass(NickelFocusLogger)

    try:
        log = logging.getLogger("nickel_focus")
        log.init(
            level=level,
            stream=stream,
            log_file=log_file,
