...
def test_update_step_updates_label(qapp, focus_sweep):
...
def test_show_single_exposure_result_updates_status(qapp, focus_sweep):
...
def test_show_failure_updates_status(qapp):
    panel = FocusControlPanel()
